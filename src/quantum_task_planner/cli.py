...
from .core.planner import QuantumTaskPlanner, PlannerConfig
from .models.task import Task, TaskPriority, TaskStatus
from .models.resource import Resource, ResourceType, ResourceStatus
from .models.schedule import Schedule, OptimizationObjective, ScheduleOptimization
    ...
    try:
        ...
        with QuantumTaskPlanner(config) as planner:
            ...
            if async_opt:
                ...
                click.echo(f"⏳ Optimization submitted asynchronously")
...
def generate_example_schedule(num_tasks: int, num_resources: int, complexity: str) -> Dict[str, Any]:
    ...
    for i, task_id in enumerate(task_ids):
        ...
        task = {
            ...
            'tags': [f"example", f"complexity_{complexity}"]
        }
